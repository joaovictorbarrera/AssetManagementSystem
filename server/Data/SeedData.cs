    ...
    public static class SeedData
    {
        ...
        public static CheckoutRequest[] CheckoutRequests { get; } =
        {
            ...
            new CheckoutRequest
            {
                ...
                AssignedAssetId = null,
                ActionedAt = new DateTime(2025, 2, 4, 0, 0, 0, DateTimeKind.Utc),
            ...
            new CheckoutRequest
            {
                ...
                AssignedAssetId = null,
                ActionedAt = new DateTime(2025, 2, 5, 0, 0, 0, DateTimeKind.Utc),
            ...
            new CheckoutRequest
            {
                ...
                ReviewedByUserId = ManagerUserId,
                AssignedAssetId = null,
                ActionedAt = new DateTime(2025, 2, 6, 0, 0, 0, DateTimeKind.Utc),
                CreatedAt = new DateTime(2025, 2, 3, 12, 0, 0, DateTimeKind.Utc)
            },

            // 1 fulfilled (tied to LAP-001, which is marked Assigned above)
            new CheckoutRequest
            {
                ...
                ActionedAt = new DateTime(2025, 1, 10, 0, 0, 0, DateTimeKind.Utc),
                CreatedAt = new DateTime(2025, 1, 8, 0, 0, 0, DateTimeKind.Utc)
            },

            // 1 returned (references the retired monitor)
            new CheckoutRequest
            {
                ...
                ActionedAt = new DateTime(2025, 1, 20, 0, 0, 0, DateTimeKind.Utc),
